...
public class Aoc7RopeBridge
{
    ...
    {
        var rb = RopeBridge.FromString(Test1);
        var res = rb.CalibrationResult(RopeBridge.OpSet1);
        Assert.That(res, Is.EqualTo(3749));
    }
    ...
    {
        var rb = RopeBridge.FromString(Test1);
        var res = rb.CalibrationResult(RopeBridge.OpSet2);
        Assert.That(res, Is.EqualTo(11387));
    }

    [Test]
    public void Solution1()
    {
        var rb = RopeBridge.FromString(Input1);
        var res = rb.CalibrationResult(RopeBridge.OpSet1);
        TestContext.Out.WriteLine(res);
        Assert.That(res, Is.EqualTo(1985268524462));
    }
    ...
    public void Solution2()
    {
        ...
        var res = rb.CalibrationResult(RopeBridge.OpSet2);
        TestContext.Out.WriteLine(res);
        Assert.That(res, Is.EqualTo(150077710195188));
    }
